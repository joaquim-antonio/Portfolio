...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="w-full flex flex-col items-center text-center gap-6">
      ...
      <h1 className="text-2xl md:text-6xl font-extrabold leading-tight tracking-tight font-sans drop-shadow-lg">
        {t("pages.contatos.heroTitle")}
      </h1>
      <p className="text-xl md:text-xl text-zinc-300 max-w-2xl mx-auto font-sans font-normal">
